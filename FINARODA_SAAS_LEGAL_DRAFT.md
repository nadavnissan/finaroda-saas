...
6. **מנוי וחיוב:** trial 14 יום **ללא כרטיס** (ללא tokenization בהרשמה, **ללא חיוב אוטומטי**; בסוף התקופה בחירה אקטיבית של המשתמש — פלאן בתשלום או Free). חיוב מתחדש חל **רק לאחר** המרה אקטיבית לתשלום ולכידת כרטיס. מסלול **Free** חינמי קבוע. מדיניות ביטול/החזר (לעו"ד — חוק הגנת הצרכן, זכות ביטול עסקה). _(change order — נדב 2026-07-09.)_
